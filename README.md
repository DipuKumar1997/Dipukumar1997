...
Backend developer focused on building scalable systems and understanding software internals.
Interested in microservices architecture, Spring ecosystem, search systems, networking, and distributed communication.

---

## About

* Java backend development with Spring Framework / Spring Boot
* Experience designing microservice-style systems
* Hands-on with streaming, authentication, and search infrastructure
* Strong interest in system-level networking concepts
